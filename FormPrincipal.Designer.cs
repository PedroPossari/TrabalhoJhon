namespace TrabalhoLipa
{
    partial class FormPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            reg_venda.Location = new Point(94, 111);
            reg_venda.Margin = new Padding(4, 0, 4, 0);
            reg_venda.Name = "reg_venda";
            reg_venda.Padding = new Padding(18, 35, 0, 0);
            ...
            Esto.Location = new Point(380, 263);
            ...
            AddProduto.Location = new Point(380, 111);
            AddProduto.Margin = new Padding(4, 0, 4, 0);
            AddProduto.Name = "AddProduto";
            AddProduto.Padding = new Padding(10, 35, 0, 0);
            ...
            H_venda.Location = new Point(94, 263);
            H_venda.Margin = new Padding(4, 0, 4, 0);
            H_venda.Name = "H_venda";
            H_venda.Padding = new Padding(4, 35, 0, 0);
            ...
            CadCliente.Location = new Point(666, 111);
            CadCliente.Margin = new Padding(4, 0, 4, 0);
            CadCliente.Name = "CadCliente";
            CadCliente.Padding = new Padding(12, 35, 0, 0);
            ...
            CadUser.Location = new Point(666, 263);
            CadUser.Margin = new Padding(4, 0, 4, 0);
            CadUser.Name = "CadUser";
            CadUser.Padding = new Padding(9, 35, 0, 0);
